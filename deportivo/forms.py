...
TAILWIND_COMPACT_NUMBER = (
    'w-16 text-center bg-gray-50 dark:bg-slate-700 border border-gray-300 dark:border-slate-600 text-gray-900 dark:text-gray-100 '
    'text-sm rounded focus:ring-blue-500 focus:border-blue-500 p-1.5'
)
TAILWIND_COMPACT_CHECKBOX = (
    'w-5 h-5 text-blue-600 bg-gray-100 dark:bg-slate-600 border-gray-300 dark:border-slate-500 rounded '
